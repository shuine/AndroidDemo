...
final class Utils {
    ...
    static int getTop(View v, boolean withoutPadding) {
        if (v == null) {
            return 0;
        }
        return (withoutPadding) ? v.getTop() + getPaddingStart(v) : v.getTop();
    }
    ...
    static int getBottom(View v, boolean withoutPadding) {
        if (v == null) {
            return 0;
        }
        return (withoutPadding) ? v.getBottom() - getPaddingEnd(v) : v.getBottom();
    }
