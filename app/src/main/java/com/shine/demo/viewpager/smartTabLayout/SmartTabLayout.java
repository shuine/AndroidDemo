 ...
 */
public class SmartTabLayout extends ScrollView {
    ...
    public SmartTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.tabViewTextColors =new ColorStateList(new int[][]{
                new int[]{
                ...
                Color.rgb(255, 111, 51), Color.rgb(255, 111, 51),Color.parseColor("#222222")
        });
